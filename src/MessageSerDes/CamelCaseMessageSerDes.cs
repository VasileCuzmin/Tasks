...
namespace MessageSerDes
{
    public class CamelCaseMessageSerDes : IMessageSerDes
    {
        private readonly IMessageTypeRegistry _messageTypeRegistry;

        public CamelCaseMessageSerDes(IMessageTypeRegistry messageTypeRegistry)
        {
        ...
        private T Deserialize<T>(byte[] data)
        {
            ...
            return JsonConvert.DeserializeObject<T>(envelopeString, new JsonSerializerSettings()
            {
